...
def get_unified_tags(post_with_metadata):
    ...
    1.Tags are unified and merged to create a shorter list.
       Example 1: "Jobseekers", "Job Hunting" can all be merged into single tag "Job Search".
       Example 2: "Motivation","Inspiration", "Drive" can be mapped to "Motivation".
       Example 3: "Personal Growth", "Personal Development", "Self Improvement" can be mapped to "Self improvement".
       Example 4 : "Scam Alert", "Job scam" etc. can be mapped to "Scams"
    2.each tag should be follow the title case convention. example : "Motivation" , "Job Search"
...
def extract_metadata(post):
    template = '''
    You are given a LinkedIn Post. You need to extract no. of lines, language of post and tags.
    1.Return a valis JSON. No preamble.
